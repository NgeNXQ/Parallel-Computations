...
public class Main
{
    public static void main(String[] args)
    {
        ...
        Result result2 = MatrixInt.multiplySequential(matrix1, matrix2);
        Result result1 = MatrixInt.multiplyStriped(matrix1, matrix2, THREADS_COUNT);
